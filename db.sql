...
--   budget_member_id INT,
--   budget_assistant_id INT,
--   PRIMARY KEY (budget_member_id, budget_assistant_id, user_group_id),
--   FOREIGN KEY (user_group_id) REFERENCES user_group ON DELETE NO ACTION,
--   FOREIGN KEY (budget_member_id) REFERENCES budget_member ON DELETE NO ACTION,
--   FOREIGN KEY (budget_assistant_id) REFERENCES budget_assistant ON DELETE NO ACTION
-- );
